    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-950">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <div className="mb-12 opacity-60">
          <div className="inline-block px-6 py-2 border border-gray-600 rounded-sm">
            <span className="text-sm font-bold tracking-[0.3em] text-gray-300">BRAUN</span>
          </div>
        </div>
        ...
        <div ref={titleRef}>
          <p
            className={`text-sm font-medium tracking-[0.25em] uppercase text-gray-500 mb-6 transition-all duration-700 ${
          ...
          <h1
            className={`text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[0.95] tracking-tight transition-all duration-1000 delay-200 ${
        ...
        <div ref={subtitleRef}>
          <p
            className={`mt-8 text-lg md:text-xl text-gray-400 max-w-md mx-auto transition-all duration-1000 delay-400 ${
              subtitleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
            }`}
          >
            Answer a few quick questions.
            <br className="hidden md:block" />
            We'll match you to the right Braun.
          </p>

          <button
            onClick={onBegin}
            className={`mt-12 group relative inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-900 font-semibold text-lg rounded-full transition-all duration-1000 delay-600 hover:scale-105 hover:shadow-2xl hover:shadow-white/10 ${
              subtitleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
            }`}
          >
